...
class UserSession {
    ...
    var $session_id = '';
    var $userID = '';//should contain the numeric id for staff, email for client
    var $browser = '';
    var $ip = '';
    var $validated = FALSE;
...
class ClientSession extends Client {
    ...
    function ClientSession($login_field) {
        parent::Client($login_field, 0, 'username');
        $this->session = new UserSession($login_field);
    }
