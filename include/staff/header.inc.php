<?php
if (!defined('OSTSCPINC') || !is_object($thisuser) || !$thisuser->isStaff() || !is_object($nav))
    die('Access Denied');
?>
<!DOCTYPE html>
<html>
    <head> 
        ...
        <link rel="stylesheet" href="css/orders.css" type="text/css" media="screen"/>
        <link rel="stylesheet" href="css/dash.css" type="text/css" media="screen"/>

        <link rel="stylesheet" href="css/autosuggest_inquisitor.css" type="text/css" media="screen" />

        <link rel="stylesheet" href="css/add_service.css" type="text/css" media="screen" />
        ...
        <div id="container" class="wrapper">
            ...
            <div id="header">
                ...
                <p id="info">Welcome back, <strong><?php echo $thisuser->getUsername() ?></strong>
                    <?php if ($thisuser->isSuperAdmin()) { ?>
                        | <a href="#">Super Admin</a>
                    <?php } elseif ( $thisuser->isAdmin() ) { ?>
                        | <a href="#">Admin</a>
                    <?php } else { ?>
                        | <a href="#">Executive Panel</a>
                    <?php } ?>
