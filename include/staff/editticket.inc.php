...
if($_POST && $errors){
    ...
    $info=array('email'=>$ticket->getEmail(),
                'alt_email'=>$ticket->getAltEmail(),
                'name'=>$ticket->getName(),
                'alt_name'=>$ticket->getAltPhone(),
                'phone'=>$ticket->getPhone(),
                'alt_phone'=>$ticket->getAltPhone(),
...
<table width="100%" border="0" cellspacing=1 cellpadding=2>
  <form action="tickets.php?id=<?php    echo  $ticket->getId() ?>" method="post">
    ...
    <tr>
        ...
        <td>
            <input type="text" id="email" name="alt_email" size="25" value="<?php    echo   $info['alt_email'];  ?>">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><b>Alternate Contact Name</b></td>
        <td>
            <input type="text" id="name" name="alt_name" size="25" value="<?php    echo   $info['alt_name'];  ?>">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="alt_phone" size="25" value="<?php    echo   $info['alt_phone_num'];  ?>"></td>
    </tr>
