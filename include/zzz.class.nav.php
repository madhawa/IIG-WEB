...
class StaffNav {
    ...
    function StaffNav($pagetype = 'staff') {
        ...
        if ($thisuser->isAdmin() && strcasecmp($pagetype, 'admin') == 0) {
            ...
            $tabs['staff'] = array('desc' => 'Executives', 'href' => 'admin.php?t=staff', 'title' => 'Executive Members');
