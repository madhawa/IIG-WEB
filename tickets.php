 ...
 * Further edited by Minhaj http://www.vimmaniac.com
 ...
 * ******************************************************************** */
/**
 * view a ticket specified by that ticket id, processes requests for adding message or attach files to the already created ticket
 */
...
//Add message and attach files into a ticket already created...depends on $ticket object above.
            ...
            */
            ...
            if ($_FILES['attachment']['name']) {
                if (!$cfg->allowOnlineAttachments()) //Something wrong with the form...user shouldn't have an option to attach
                    $errors['attachment'] = 'File [ ' . $_FILES['attachment']['name'] . ' ] rejected, online attachments not allowed';
